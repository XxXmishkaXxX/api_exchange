...
async def get_orderbook(
    ...
    pair: Annotated[str, Query("RUB", description="Пара актива, например USDT")],
    limit: Annotated[int, Query(10, ge=1, le=1000, description="Лимит заявок для отображения")],
...
async def get_all_transactions_by_pair(
    ticker: Annotated[str, Path(description="Тикер актива (например BTC)")],
    pair: Annotated[str, Query("RUB", description="Пара актива, например USDT")],
    limit: Annotated[int, Query(10, ge=1, le=1000)],
